 ...
 <p>&nbsp;</p></html>", revisions = ""),
  ...
  package Boards "Components to connect to the Firmata boards"
    ...
    equation
      ...
      annotation(
        Documentation(info = "<html><p>This component provides a ready-to-use configuration for the Arduino board. This component has been tested with Arduino Uno, Arduino Mega 2560, and Arduino Mini, but it should work with any Arduino board.</p>
  <p>When running the simulation, you will get a list of the capabilities of every pin. If you want to stop showing the capabilities every time you simulate, you need to set the property 'ShowCapabilities' to false. If you are not sure about the location of a specific pin in your board, you should&nbsp;check the documentation for&nbsp;your board.</p></html>", revisions = ""),
    ...
    equation
      ...
      boardConnector = BoardId;
      annotation(
        Documentation(info = "<html><p>This component provides a ready-to-use configuration for boards flashed with the StandardFirmata. This component has been tested with chipKIT UNO and Teensy 3.1, but it should work with any board supporting the StandardFirmata.</p>
  ...
  <p>&nbsp;</p></html>", revisions = ""),
    ...
    equation
      ...
      boardConnector = BoardId;
      annotation(
        Documentation(info = "<html><p>This component is for advanced users who&nbsp;can modify the Firmata source code or have a non-Arduino board running Firmata.&nbsp;This component allows you to specify your preferred baud rate and sampling interval.&nbsp;</p>
      ...
      <p>When setting the 'UpdatePeriod' property, it is necessary to change the \"Interval length\" in the simulation settings, to match the update period.</p></html>", revisions = ""),
    ...
    equation
      ...
      boardConnector = BoardId;
      annotation(
        Documentation(info = "<html><p>This component provides a ready-to-use configuration for the Arduino Leonardo board. This component works for any board using native USB communication, like the Arduino Esplora.</p>
     <p>When running the simulation, you will get a list of the capabilities of every pin. If you want to stop showing the capabilities every time you simulate, you need to set the property &quot;ShowCapabilities&quot; to false.</p></html>", revisions = ""),
...
<p><img src=\"modelica://OpenModelicaEmbedded/Resources/Images/Blink.png\" alt=\"\"/></p></html>", revisions = ""),
   ...
   <a href=\"modelica://OpenModelicaEmbedded.Examples.BlinkLed\">Blink Led</a> can be used with an Arduino Leonardo.</p></html>", revisions = ""));
    ...
    <p><img src=\"modelica://OpenModelicaEmbedded/Resources/Images/Interval.png\" alt=\"\" /></p></html>", revisions = ""),
        Diagram(coordinateSystem(extent = {{-50, -50}, {50, 50}}, initialScale = 0.1, grid = {5, 5})));
    ...
    <p>You can go ahead and add more LEDs to the board as shown in the following figure. This will require you to add one more DigitalOutput component to control the LED on pin 9.</p>
    <p><img src=\"modelica://OpenModelicaEmbedded/Resources/Images/StandardFirmata.png\" alt=\"\" /></p></html>", revisions = ""),
        Diagram(coordinateSystem(extent = {{-50, -50}, {50, 50}}, initialScale = 0.1, grid = {5, 5})));
  ...
  annotation(
    preferredView = "info",
    Diagram(coordinateSystem(extent = {{-148.5, -105}, {148.5, 105}}, preserveAspectRatio = true, initialScale = 0.1, grid = {5, 5})),
    Documentation(info = "<html> <h4>What Is ModelPlug?</h4>
